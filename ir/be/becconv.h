...
static inline unsigned *be_cconv_alloc_all_regs(struct obstack *const obst,
                                                size_t const n) {
...
static inline void be_cconv_add_regs(unsigned *const dst,
                                     unsigned const *const regs,
                                     size_t const n) {
...
static inline void be_cconv_rem_regs(unsigned *const dst,
                                     unsigned const *const regs,
                                     size_t const n) {
  for (size_t i = 0; i != n; ++i) {
