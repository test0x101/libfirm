 ...
 */
static bool set_opt_module(void *const data, size_t const length,
...
void be_add_module_list_opt(lc_opt_entry_t *grp, const char *name,
  ...
  lc_opt_add_opt(grp, name, description, lc_opt_type_enum, moddata,
                 sizeof(moddata[0]), set_opt_module, dump_opt_module,
