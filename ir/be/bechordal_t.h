...
static inline struct list_head *get_block_border_head(
    be_chordal_env_t const *const inf, ir_node *const bl) {
...
void be_chordal_dump(unsigned mask, ir_graph *irg,
                     arch_register_class_t const *cls, char const *suffix);
