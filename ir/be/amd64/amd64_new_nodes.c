...
int amd64_attrs_equal(const ir_node *a, const ir_node *b) {
  ...
  return attr_a->op_mode == attr_b->op_mode && attr_a->size == attr_b->size;
}
...
int amd64_binop_addr_attrs_equal(const ir_node *a, const ir_node *b) {
  ...
  if (!amd64_addr_attrs_equal(a, b)) return false;
...
int amd64_copyb_attrs_equal(const ir_node *const a, const ir_node *const b) {
  ...
  return amd64_attrs_equal(a, b) && attr_a->size == attr_b->size;
}
...
int amd64_shift_attrs_equal(const ir_node *const a, const ir_node *const b) {
  ...
  return amd64_attrs_equal(a, b) && attr_a->immediate == attr_b->immediate;
}
...
int amd64_switch_jmp_attrs_equal(const ir_node *const a,
...
int amd64_call_addr_attrs_equal(const ir_node *const a,
                                const ir_node *const b) {
