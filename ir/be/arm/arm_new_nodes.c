  ...
  switch (reason) {
    case dump_node_opcode_txt:
      ...
      if (arm_has_address_attr(n)) {
        ...
        if (attr->entity != NULL) ir_fprintf(F, " %F", attr->entity);
      }
      break;
    ...
    case dump_node_info_txt:
      if (has_load_store_attr(n)) {
        const arm_load_store_attr_t *attr = get_arm_load_store_attr_const(n);
...
int arm_Address_attrs_equal(const ir_node *a, const ir_node *b) {
  ...
  return arm_attrs_equal(a, b) && attr_a->entity == attr_b->entity &&
...
const arm_load_store_attr_t *get_arm_load_store_attr_const(
    const ir_node *node) {
...
int arm_load_store_attrs_equal(const ir_node *a, const ir_node *b) {
  ...
  return arm_attrs_equal(a, b) &&
         ...
         attr_a->entity == attr_b->entity && attr_a->offset == attr_b->offset &&
