...
static void x86_parse_constraint_letter(void const *const env,
                                        be_asm_constraint_t *const c,
                                        char const l) {
  x86_asm_constraint_list_t const *const constraints =
      (x86_asm_constraint_list_t const *)env;
...
ir_node *x86_match_ASM(ir_node const *const node,
                       x86_asm_constraint_list_t const *const constraint_list) {
  ...
  x86_asm_operand_t *const operands =
      NEW_ARR_DZ(x86_asm_operand_t, obst, n_constraints);
...
void x86_set_be_asm_constraint_support(
