...
/* feature definitions for cpu variants (selectable through
 * -march=.../-mtune=... options) */
cpu_arch_features cpu_arch_feature_defs[cpu_max] = {
    ...
    [cpu_pentium_2] = {arch_ppro,
                       arch_feature_cmov | arch_feature_fcmov | arch_mmx_insn},
    [cpu_pentium_3] = {arch_ppro,
                       arch_feature_cmov | arch_feature_fcmov | arch_sse1_insn},
    [cpu_pentium_m] = {arch_ppro,
                       arch_feature_cmov | arch_feature_fcmov | arch_sse2_insn},
    [cpu_pentium_4] = {arch_netburst,
                       arch_feature_cmov | arch_feature_fcmov | arch_sse2_insn},
    [cpu_prescott] = {arch_nocona,
                      arch_feature_cmov | arch_feature_fcmov | arch_sse3_insn},
    [cpu_nocona] = {arch_nocona, arch_feature_cmov | arch_feature_fcmov |
                                     arch_64bit_insn | arch_sse3_insn},
    [cpu_core2] = {arch_core2, arch_feature_cmov | arch_feature_fcmov |
                                   arch_64bit_insn | arch_ssse3_insn},
    [cpu_penryn] = {arch_core2, arch_feature_cmov | arch_feature_fcmov |
                                    arch_64bit_insn | arch_sse4_1_insn},
    [cpu_nehalem] = {arch_nehalem, arch_feature_cmov | arch_feature_fcmov |
                                       arch_64bit_insn | arch_sse4_2_insn |
                                       arch_feature_popcnt},
    [cpu_westmere] = {arch_nehalem, arch_feature_cmov | arch_feature_fcmov |
                                        arch_64bit_insn | arch_sse4_2_insn |
                                        arch_feature_popcnt},
    [cpu_sandybridge] = {arch_sandybridge, arch_feature_cmov |
                                               arch_feature_fcmov |
                                               arch_64bit_insn | arch_avx_insn |
                                               arch_feature_popcnt},
    [cpu_ivybridge] = {arch_sandybridge, arch_feature_cmov |
                                             arch_feature_fcmov |
                                             arch_64bit_insn | arch_avx_insn |
                                             arch_feature_popcnt},
    [cpu_haswell] = {arch_haswell, arch_feature_cmov | arch_feature_fcmov |
                                       arch_64bit_insn | arch_avx2_insn |
                                       arch_feature_popcnt | arch_feature_fma},
    [cpu_broadwell] = {arch_haswell, arch_feature_cmov | arch_feature_fcmov |
                                         arch_64bit_insn | arch_avx2_insn |
                                         arch_feature_popcnt |
                                         arch_feature_fma},
    [cpu_skylake] = {arch_skylake, arch_feature_cmov | arch_feature_fcmov |
                                       arch_64bit_insn | arch_avx2_insn |
                                       arch_feature_popcnt | arch_feature_fma},
    [cpu_skylake_avx512] = {arch_skylake,
                            arch_feature_cmov | arch_feature_fcmov |
                                arch_64bit_insn | arch_avx2_insn |
                                arch_feature_popcnt | arch_feature_fma},
    [cpu_cascade_lake] = {arch_skylake, arch_feature_cmov | arch_feature_fcmov |
                                            arch_64bit_insn | arch_avx2_insn |
                                            arch_feature_popcnt |
                                            arch_feature_fma},
    [cpu_cooperlake] = {arch_skylake, arch_feature_cmov | arch_feature_fcmov |
                                          arch_64bit_insn | arch_avx2_insn |
                                          arch_feature_popcnt |
                                          arch_feature_fma},
    [cpu_cannonlake] = {arch_skylake, arch_feature_cmov | arch_feature_fcmov |
                                          arch_64bit_insn | arch_avx2_insn |
                                          arch_feature_popcnt |
                                          arch_feature_fma},
    [cpu_icelake_client] = {arch_sunnycove,
                            arch_feature_cmov | arch_feature_fcmov |
                                arch_64bit_insn | arch_avx2_insn |
                                arch_feature_popcnt | arch_feature_fma},
    [cpu_icelake_server] = {arch_sunnycove,
                            arch_feature_cmov | arch_feature_fcmov |
                                arch_64bit_insn | arch_avx2_insn |
                                arch_feature_popcnt | arch_feature_fma},
    [cpu_tigerlake] = {arch_sunnycove, arch_feature_cmov | arch_feature_fcmov |
                                           arch_64bit_insn | arch_avx2_insn |
                                           arch_feature_popcnt |
                                           arch_feature_fma},
    [cpu_sapphirerapids] = {arch_sunnycove,
                            arch_feature_cmov | arch_feature_fcmov |
                                arch_64bit_insn | arch_avx2_insn |
                                arch_feature_popcnt | arch_feature_fma},
    [cpu_alderlake] = {arch_sunnycove, arch_feature_cmov | arch_feature_fcmov |
                                           arch_64bit_insn | arch_avx2_insn |
                                           arch_feature_popcnt |
                                           arch_feature_fma},

    [cpu_atom] = {arch_atom,
                  arch_feature_cmov | arch_feature_fcmov | arch_ssse3_insn},
    [cpu_silvermont] = {arch_silvermont,
                        arch_feature_cmov | arch_feature_fcmov |
                            arch_sse4_2_insn | arch_feature_popcnt},
    [cpu_goldmont] = {arch_goldmont, arch_feature_cmov | arch_feature_fcmov |
                                         arch_sse4_2_insn |
                                         arch_feature_popcnt},
    [cpu_goldmont_plus] = {arch_goldmont_plus,
                           arch_feature_cmov | arch_feature_fcmov |
                               arch_sse4_2_insn | arch_feature_popcnt},
    [cpu_tremont] = {arch_tremont, arch_feature_cmov | arch_feature_fcmov |
                                       arch_sse4_2_insn | arch_feature_popcnt},
    [cpu_knl] = {arch_silvermont, arch_feature_cmov | arch_feature_fcmov |
                                      arch_feature_avx2 | arch_feature_popcnt},
    [cpu_knm] = {arch_silvermont, arch_feature_cmov | arch_feature_fcmov |
                                      arch_feature_avx2 | arch_feature_popcnt},
    ...
    [cpu_athlon_old] = {arch_athlon, arch_3DNowE_insn | arch_feature_cmov |
                                         arch_feature_fcmov},
    [cpu_athlon] = {arch_athlon, arch_sse1_insn | arch_3DNowE_insn |
                                     arch_feature_cmov | arch_feature_fcmov},
    [cpu_athlon64] = {arch_athlon, arch_3DNowE_insn | arch_feature_cmov |
                                       arch_feature_fcmov | arch_64bit_insn},
    [cpu_k8] = {arch_k8, arch_3DNowE_insn | arch_feature_cmov |
                             arch_feature_fcmov | arch_64bit_insn},
    [cpu_k8_sse3] = {arch_k8, arch_3DNowE_insn | arch_feature_cmov |
                                  arch_feature_fcmov | arch_64bit_insn |
                                  arch_sse3_insn},
    [cpu_k10] = {arch_k10, arch_3DNowE_insn | arch_feature_cmov |
                               arch_feature_fcmov | arch_feature_popcnt |
                               arch_64bit_insn | arch_sse4a_insn},
    [cpu_btver1] = {arch_amdfam14h, arch_feature_cmov | arch_feature_fcmov |
                                        arch_feature_popcnt | arch_64bit_insn |
                                        arch_sse4a_insn},
    [cpu_btver2] = {arch_amdfam16h, arch_feature_cmov | arch_feature_fcmov |
                                        arch_feature_popcnt | arch_64bit_insn |
                                        arch_sse4a_insn | arch_avx_insn},
    [cpu_bdver1] = {arch_amdfam15h, arch_feature_cmov | arch_feature_fcmov |
                                        arch_feature_popcnt | arch_64bit_insn |
                                        arch_sse4a_insn | arch_avx_insn},
    [cpu_bdver2] = {arch_amdfam15h, arch_feature_cmov | arch_feature_fcmov |
                                        arch_feature_popcnt | arch_64bit_insn |
                                        arch_sse4a_insn | arch_avx_insn |
                                        arch_feature_fma},
    [cpu_bdver3] = {arch_amdfam15h, arch_feature_cmov | arch_feature_fcmov |
                                        arch_feature_popcnt | arch_64bit_insn |
                                        arch_sse4a_insn | arch_avx_insn |
                                        arch_feature_fma},
    [cpu_bdver4] = {arch_amdfam15h, arch_feature_cmov | arch_feature_fcmov |
                                        arch_feature_popcnt | arch_64bit_insn |
                                        arch_sse4a_insn | arch_avx2_insn |
                                        arch_feature_fma},
    [cpu_znver1] = {arch_amdfam17h, arch_feature_cmov | arch_feature_fcmov |
                                        arch_feature_popcnt | arch_64bit_insn |
                                        arch_sse4a_insn | arch_avx2_insn |
                                        arch_feature_fma},
    [cpu_znver2] = {arch_amdfam17h, arch_feature_cmov | arch_feature_fcmov |
                                        arch_feature_popcnt | arch_64bit_insn |
                                        arch_sse4a_insn | arch_avx2_insn |
                                        arch_feature_fma},
    [cpu_znver3] = {arch_amdfam19h, arch_feature_cmov | arch_feature_fcmov |
                                        arch_feature_popcnt | arch_64bit_insn |
                                        arch_sse4a_insn | arch_avx2_insn |
                                        arch_feature_fma},
    ...
    [cpu_c3_2] = {arch_ppro, arch_feature_cmov | arch_feature_fcmov |
                                 arch_sse1_insn}, /* really no 3DNow! */
...
static void x86_cpuid(cpuid_registers *regs, unsigned level) {
  ...
  __asm(
      ...
      "cpuid\n\t"
      "xchgl %%ebx, %1"
      : "=a"(regs->r.eax), "=r"(regs->r.ebx), "=c"(regs->r.ecx),
        "=d"(regs->r.edx)
      : "a"(level));
#else
  __asm("cpuid\n\t"
        : "=a"(regs->r.eax), "=b"(regs->r.ebx), "=c"(regs->r.ecx),
          "=d"(regs->r.edx)
        : "a"(level));
#endif
...
#if defined(__GNUC__)
#ifdef __i386__
  /* If bit 21 of the EFLAGS register can be changed, the cpuid instruction is
   * available */
  __asm__(
      "pushf\n\t"
      "popl %0\n\t"
...
cpu_arch_features autodetect_arch(void) {
  ...
  if (x86_toggle_cpuid()) {
    ...
    if ((cpu_info.ecx_features &
         (CPUID_FEAT_ECX_OSXSAVE | CPUID_FEAT_ECX_AVX)) ==
        (CPUID_FEAT_ECX_OSXSAVE | CPUID_FEAT_ECX_AVX)) {
      // TODO: full AVX support detection
      //  (see for example
      //  https://github.com/llvm/llvm-project/blob/main/compiler-rt/lib/builtins/cpu_model.c)
    ...
    if (max_cpuid_level >= 7) {
      ...
      if (feature_flags(auto_arch, arch_feature_avx) &&
          cpu_info.ext_ebx_features & CPUID_EXT_FEAT_EBX_AVX2) {
