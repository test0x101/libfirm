...
typedef enum x86_cpu_architectures {
  ...
  arch_athlon_plus = arch_athlon | arch_k8 | arch_k10 | arch_amdfam15h |
                     arch_amdfam14h | arch_amdfam16h | arch_amdfam17h |
                     arch_amdfam19h,
  arch_all_amd = arch_k6 | arch_geode | arch_athlon_plus,
  arch_core2_plus = arch_core2 | arch_nehalem | arch_sandybridge |
                    arch_haswell | arch_skylake | arch_sunnycove,
  arch_atom_plus = arch_atom | arch_silvermont | arch_goldmont |
                   arch_goldmont_plus | arch_tremont
...
typedef enum x86_cpu_features {
  ...
  arch_sse1_insn =
      arch_feature_sse1 | arch_mmx_insn, /**< SSE1 instructions, include MMX */
  arch_sse2_insn = arch_feature_sse2 |
                   arch_sse1_insn, /**< SSE2 instructions, include SSE1 */
  arch_sse3_insn = arch_feature_sse3 |
                   arch_sse2_insn, /**< SSE3 instructions, include SSE2 */
  arch_ssse3_insn = arch_feature_ssse3 |
                    arch_sse3_insn, /**< SSSE3 instructions, include SSE3 */
  arch_sse4_1_insn = arch_feature_sse4_1 |
                     arch_ssse3_insn, /**< SSE4.1 instructions, include SSSE3 */
  arch_sse4_2_insn =
      arch_feature_sse4_2 |
      arch_sse4_1_insn, /**< SSE4.2 instructions, include SSE4.1 */
  arch_sse4a_insn = arch_feature_sse4a |
                    arch_ssse3_insn, /**< SSE4a instructions, include SSSE3 */
  arch_avx_insn = arch_feature_avx |
                  arch_sse4_2_insn, /**< AVX instructions, include SSE4.2 */
  arch_avx2_insn =
      arch_feature_avx2 | arch_avx_insn, /**< AVX2 instructions, include AVX */

  arch_3DNow_insn = arch_feature_3DNow |
                    arch_feature_mmx, /**< 3DNow! instructions, including MMX */
  arch_3DNowE_insn = arch_feature_3DNowE |
                     arch_3DNow_insn, /**< Enhanced 3DNow! instructions */
  arch_64bit_insn =
      arch_feature_64bit | arch_sse2_insn, /**< x86_64 support, includes SSE2 */
