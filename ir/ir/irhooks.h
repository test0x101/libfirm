...
struct hook_entry {
  ...
  union {
    /** This hook is called, after a new IR-node was created and before it is
     * optimized. */
    ...
    /** This hook is called, after a new graph was created and before the first
     * block on this graph is built. */
    ...
    /** This hook is called at the end of the node info dumper to dump
