 ...
 */
static inline uint32_t log2_floor(uint32_t x) { return 32 - 1 - nlz(x); }
 ...
 * @return The power of two.
 */
static inline uint32_t log2_ceil(uint32_t x) { return 32 - nlz(x - 1); }
 ...
 */
static inline bool is_po2_or_zero(unsigned x) { return (x & (x - 1)) == 0; }
