...
#define get_method_additional_properties(method) \
  get_method_additional_properties_(method)
#define get_method_calling_convention(method) \
  get_method_calling_convention_(method)
...
typedef struct {
  ...
  int variadic; /**< The variadicity of the method. -1: method is not variadic
                 Values >= 0 represent the index of the first variadic
                 parameter. */
  mtp_additional_properties
      properties;            /**< Set of additional method properties. */
...
typedef enum type_flags {
  ...
  tf_info = 1U << 3, /**< infos (for example constructor, destructor pointers),
 ...
 * @param variadic_index index of the first variadic parameter, -1 if method is
 * not variadic
 * @param property_mask  additional method properties for the cloned type
 *
 * @return the cloned method type.
 */
ir_type *clone_type_method(ir_type *tp, int variadic_index,
 ...
 * Values >= 0 represent the index of the first variadic parameter which equals
 * the number of named parameters. A value of -1 marks the method as not
 * variadic.
 * @param method
...
static inline mtp_additional_properties get_method_additional_properties_(
