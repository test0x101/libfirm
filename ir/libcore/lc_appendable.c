...
static void default_init(lc_appendable_t *env) { (void)env; }

static void default_finish(lc_appendable_t *env) { (void)env; }
...
static lc_appendable_funcs_t app_file = {default_init, default_finish,
                                         file_snadd, file_chadd};
...
static lc_appendable_funcs_t app_string = {str_init, str_finish, str_snadd,
                                           str_chadd};
...
static lc_appendable_funcs_t app_obstack = {default_init, default_finish,
                                            obst_snadd, obst_chadd};
