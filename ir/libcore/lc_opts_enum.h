...
#define _LC_OPT_ENT_ENUM(N, name, desc, var)                                 \
  _LC_OPT_ENT(name, desc, lc_opt_type_enum, lc_opt_enum_##N##_var_t, var, 0, \
              lc_opt_enum_##N##_cb, lc_opt_enum_##N##_dump,                  \
              lc_opt_enum_##N##_dump_vals)

_LC_OPT_DECL_ENUM(int, int)
_LC_OPT_DECL_ENUM(unsigned, mask)

#define LC_OPT_ENT_ENUM_INT(name, desc, var) \
  _LC_OPT_ENT_ENUM(int, name, desc, var)
#define LC_OPT_ENT_ENUM_MASK(name, desc, var) \
  _LC_OPT_ENT_ENUM(mask, name, desc, var)
...
#define LC_OPT_ENT_ENUM_FUNC_PTR(name, desc, var) \
  _LC_OPT_ENT_ENUM(func_ptr, name, desc, var)
