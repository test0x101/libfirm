...
FIRM_API int _obstack_begin(struct obstack *, int, int, void *(*)(ptrdiff_t),
                            void (*)(void *));
...
#define obstack_init(h)                                                \
  _obstack_begin((h), 0, 0, (void *(*)(ptrdiff_t))obstack_chunk_alloc, \
                 (void (*)(void *))obstack_chunk_free)

#define obstack_begin(h, size)                                              \
  _obstack_begin((h), (size), 0, (void *(*)(ptrdiff_t))obstack_chunk_alloc, \
                 (void (*)(void *))obstack_chunk_free)

#define obstack_specify_allocation(h, size, alignment, chunkfun, freefun)    \
  _obstack_begin((h), (size), (alignment), (void *(*)(ptrdiff_t))(chunkfun), \
                 (void (*)(void *))(freefun))
...
#define obstack_chunkfun(h, newchunkfun) \
  ((h)->chunkfun =                       \
       (struct _obstack_chunk * (*)(void *, ptrdiff_t))(newchunkfun))
...
FIRM_API int obstack_vprintf(struct obstack *obst, const char *fmt,
                             va_list ap) FIRM_NOTHROW FIRM_PRINTF(2, 0);
